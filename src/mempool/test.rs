...
fn selects_transactions_by_fee_without_breaking_sender_nonce_order() {
    ...
    assert_eq!(selected[0].payload.fee, Amount(crate::params::FAST_FEE));
    ...
    assert_eq!(
        ...
        Amount(crate::params::AGGRESSIVE_FEE)
    );
}
